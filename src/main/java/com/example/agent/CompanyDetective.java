...
public class CompanyDetective {
    public static void main(String[] args) {
        ...
        // 1. The three parallel worker agents
        var companyProfiler = LlmAgent.builder()
            .name("company-profiler")
            .description("Creates a profile of a company.")
            .instruction("""
                Your role is to create a brief profile of the given company.
        ...
        var newsFinder = LlmAgent.builder()
            ...
            .instruction("""
                ...
                Use the Google Search Tool. Present the results as a bulleted list.
            """)
            .model("gemini-2.5-flash")
            .tools(new GoogleSearchTool())
            .outputKey("news")
        ...
        // 2. The Orchestrator that runs them concurrently
        ...
        // 3. The final compiler that waits for the parallel tasks to finish
        ...
        // 4. Wrap everything in a Sequential workflow
