...
public class CodeRefiner {
    public static void main(String[] args) {
        ...
        var codeReviewer = LlmAgent.builder()
            ...
            .model("gemini-2.5-flash")
            .outputKey("feedback")
            .tools(ExitLoopTool.INSTANCE) // This tool gives the agent the power to break the loop
            .build(); //
        ...
        var codeRefinerLoop = LoopAgent.builder()
            ...
            .subAgents(codeGenerator, codeReviewer)
        ...
        AdkWebServer.start(SequentialAgent.builder()
            ...
            .subAgents(codeRefinerLoop, finalPresenter)
            .build()); //
    }
}